...
var file_dhcpd_proto_goTypes = []interface{}{
	(*DHCPD)(nil),                 // 0: com.pojtinger.felicitas.goISCDHCP.DHCPD
	(*Subnet)(nil),                // 1: com.pojtinger.felicitas.goISCDHCP.Subnet
	(*Range)(nil),                 // 2: com.pojtinger.felicitas.goISCDHCP.Range
	(*DHCPDManaged)(nil),          // 3: com.pojtinger.felicitas.goISCDHCP.DHCPDManaged
	(*DHCPDManagerListArgs)(nil),  // 4: com.pojtinger.felicitas.goISCDHCP.DHCPDManagerListArgs
	(*DHCPDManagedId)(nil),        // 5: com.pojtinger.felicitas.goISCDHCP.DHCPDManagedId
	(*DHCPDManagerListReply)(nil), // 6: com.pojtinger.felicitas.goISCDHCP.DHCPDManagerListReply
}
var file_dhcpd_proto_depIdxs = []int32{
	1, // 0: com.pojtinger.felicitas.goISCDHCP.DHCPD.Subnets:type_name -> com.pojtinger.felicitas.goISCDHCP.Subnet
	2, // 1: com.pojtinger.felicitas.goISCDHCP.Subnet.Range:type_name -> com.pojtinger.felicitas.goISCDHCP.Range
	1, // 2: com.pojtinger.felicitas.goISCDHCP.DHCPDManaged.Subnets:type_name -> com.pojtinger.felicitas.goISCDHCP.Subnet
	3, // 3: com.pojtinger.felicitas.goISCDHCP.DHCPDManagerListReply.DHCPDsManaged:type_name -> com.pojtinger.felicitas.goISCDHCP.DHCPDManaged
	0, // 4: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Create:input_type -> com.pojtinger.felicitas.goISCDHCP.DHCPD
	4, // 5: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.List:input_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagerListArgs
	5, // 6: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Get:input_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagedId
	5, // 7: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Delete:input_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagedId
	5, // 8: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Create:output_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagedId
	6, // 9: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.List:output_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagerListReply
	3, // 10: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Get:output_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManaged
	5, // 11: com.pojtinger.felicitas.goISCDHCP.DHCPDManager.Delete:output_type -> com.pojtinger.felicitas.goISCDHCP.DHCPDManagedId
...
func (c *dHCPDManagerClient) Create(ctx context.Context, in *DHCPD, opts ...grpc.CallOption) (*DHCPDManagedId, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dHCPDManagerClient) List(ctx context.Context, in *DHCPDManagerListArgs, opts ...grpc.CallOption) (*DHCPDManagerListReply, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dHCPDManagerClient) Get(ctx context.Context, in *DHCPDManagedId, opts ...grpc.CallOption) (*DHCPDManaged, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dHCPDManagerClient) Delete(ctx context.Context, in *DHCPDManagedId, opts ...grpc.CallOption) (*DHCPDManagedId, error) {
	out := new(DHCPDManagedId)
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DHCPDManager_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Create",
	}
...
func _DHCPDManager_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DHCPDManager_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DHCPDManager_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.goISCDHCP.DHCPDManager/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DHCPDManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.pojtinger.felicitas.goISCDHCP.DHCPDManager",
